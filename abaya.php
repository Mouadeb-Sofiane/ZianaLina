...
<body>
    ...
    <div class="img-container">
        <div class="image-container1">
            <img class="img_boussole" src="<?php echo get_template_directory_uri() . '/img/banniere_abaya.svg'; ?>" alt="Image qui montre que l'on est dans la section abaya" />
        </div>
    </div>
    ...
    <div class="products">
        ...
        $args = array(
            ...
            'product_cat'    => 'abaya', // Catégorie de produits
