...
<body>
    ...
    <div class="img-container">
        <div class="image-container1">
            <img class="img_boussole" src="<?php echo get_template_directory_uri() . '/img/banniere_parfum.svg'; ?>" alt="Image qui montre que l'on est dans la section abaya" />
        </div>
    </div>
    ...
    <div class="products">
        <?php
        // Récupérer les produits de la catégorie "parfum"
        $args = array(
            'post_type'      => 'product',
            'posts_per_page' => -1, // Afficher tous les produits
            'product_cat'    => 'parfum', // Catégorie de produits
